...
"""
    ...
    socket =
      assign(socket,
        ...
        article_items: [
          %{type: :section, id: "section_intro", title: "The Dawn of an Idea", content: section_markdown},
          %{type: :aside, id: "aside_quick_thought", title: "A Fleeting Observation", content: aside_markdown},
          %{type: :enhanced_media, id: "media_visual_break", title: "Visualizing the Concept", content: media_caption_markdown, media_url: "https://via.placeholder.com/800x400.png/eee/888?text=Enhanced+Media+Placeholder"}
        ]
      )
