defmodule Blog.Integration.ChatFlowTest do
  ...
  describe "Complete chat workflow" do
    ...
    test "users can join multiple rooms independently", %{
      user_id_1: user_id_1,
      user_id_2: user_id_2
    } do
      ...
      ref =
        push(socket1_general, "new_message", %{
  ...
  describe "Message history and persistence" do
    test "joining room returns recent message history", %{
      user_id_1: user_id_1,
      user_id_2: user_id_2
    } do
      ...
      # Chat typically limits to recent messages
  ...
  describe "Error handling and edge cases" do
    ...
    test "handles concurrent message sending", %{user_id_1: user_id_1} do
      ...
      tasks =
        for {socket, i} <- Enum.with_index(sockets, 1) do
          Task.async(fn ->
            ref =
              push(socket, "new_message", %{
  ...
  describe "Performance and scalability" do
    test "handles high message volume efficiently", %{user_id_1: user_id_1} do
      ...
      # Less than 5 seconds for 50 messages
